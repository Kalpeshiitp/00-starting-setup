...
// Define a function to handle the route for displaying a single product
exports.getProduct = (req, res, next) => {
  // Extract the product ID from the request parameters
  const prodId = req.params.productId;
  // Find the product by ID and render the 'product-detail' view with the product data
...
exports.getIndex = (req, res, next) => {
  // Fetch all products and pass them to the 'index' view for rendering
  Product.fetchAll(products => {
...
exports.postCartDeleteProduct = (req, res, next) => {
  // Extract the product ID from the request body
  const prodId = req.body.productId;
  // Find the product by ID and remove it from the cart
  Product.findById(prodId, product => {
